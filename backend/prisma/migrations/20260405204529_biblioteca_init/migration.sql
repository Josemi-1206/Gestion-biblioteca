/*
  ...
  - You are about to drop the `AsignacionDocente` table. If the table is not empty, all the data it contains will be lost.
  ...
  - You are about to drop the `PeriodoAcademico` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `ProgramaAcademico` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "AsignacionDocente" DROP CONSTRAINT "AsignacionDocente_asignaturaId_fkey";

-- DropForeignKey
ALTER TABLE "AsignacionDocente" DROP CONSTRAINT "AsignacionDocente_docenteId_fkey";

-- DropForeignKey
ALTER TABLE "AsignacionDocente" DROP CONSTRAINT "AsignacionDocente_periodoAcademicoId_fkey";

-- DropForeignKey
ALTER TABLE "Asignatura" DROP CONSTRAINT "Asignatura_programaId_fkey";

-- DropForeignKey
ALTER TABLE "Calificacion" DROP CONSTRAINT "Calificacion_matriculaId_fkey";

-- DropForeignKey
ALTER TABLE "Estudiante" DROP CONSTRAINT "Estudiante_programaId_fkey";

-- DropForeignKey
ALTER TABLE "Matricula" DROP CONSTRAINT "Matricula_asignacionDocenteId_fkey";
