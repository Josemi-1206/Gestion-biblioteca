...
export class MultasController {
  ...
  @Patch(':id/pagar')
  pagar(@Param('id') id: string) { return this.service.pagar(+id); }

  @Post()
  create(@Body() dto: CreateMultaDto) { return this.service.create(dto); }

  @Put(':id')
  update(@Param('id') id: string, @Body() dto: UpdateMultaDto) { return this.service.update(+id, dto); }
